...
fastify.get("/treedata", async (request, reply) => {
  const data = await db.runQuery1("SELECT * FROM Trees, A_TREE_butes WHERE Trees.tree_name LIKE A_TREE_butes.scientific_name OR Trees.tree_name LIKE A_TREE_butes.tree_name");
  console.log(data);
